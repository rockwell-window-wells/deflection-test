...
if __name__ == "__main__":
    ...
    ref_heights = [0, -250, -500]
    # ref_point = np.array([0, 0, 0])  # Example: Origin, you can change this
    
    # Angular range (in degrees), adjusting as needed
    theta_range = np.linspace(90, 270, 100)  # Azimuth angles (around the object)
    phi_range = np.linspace(-90, 90, 100)   # Elevation angles (up/down)
    ...
    displacement_magnitudes = measure_displacement(pcd, pcd_deformed)